...
export const CATEGORIES: Record<ShiftType, CategoryMeta> = {
  regular:  { id: 'regular',  label: 'Regular',  color: '#34c98a', soft: 'rgba(52,201,138,.12)',  line: 'rgba(52,201,138,.30)'  },
  overtime: { id: 'overtime', label: 'Overtime', color: '#f5b14c', soft: 'rgba(245,177,76,.12)',  line: 'rgba(245,177,76,.32)'  },
  night:    { id: 'night',    label: 'Night',    color: '#8b8bf5', soft: 'rgba(139,139,245,.14)', line: 'rgba(139,139,245,.34)' },
  training: { id: 'training', label: 'Training', color: '#4cc3f5', soft: 'rgba(76,195,245,.12)',  line: 'rgba(76,195,245,.32)'  },
  leave:    { id: 'leave',    label: 'Time off', color: '#71717a', soft: 'rgba(113,113,122,.14)', line: 'rgba(113,113,122,.34)' },
}
