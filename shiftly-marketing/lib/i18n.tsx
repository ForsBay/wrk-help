...
const DICT = {
  en: {
    ...
    stats: {
      ...
      title: 'Built for shift workers — honest from day one',
      items: [
        { label: 'Currencies',     description: 'PLN, RUB, USD, EUR, GBP and more — switch anytime' },
        { label: 'Overtime rates', description: '1.25×, 1.5× and 2× multipliers built in' },
        { label: 'Price',          description: 'Free during early access — no card needed' },
        { label: 'Per shift',      description: 'Average time to log a full shift' },
      ],
    },
    comparison: {
      kicker: 'Why Shiftly',
    ...
    modal: {
      title: 'Coming soon',
      desc: "This platform is currently under development. Leave your email and we'll notify you when it's available.",
      close: 'Close',
    },
    testimonials: {
      badge: 'Early access',
      title: 'What our first testers say',
      sub: "Shiftly is in early access. Here's honest feedback from the shift workers trying it now.",
      note: 'Early access · feedback from our first testers',
      items: [
        { name: 'Kacper', role: 'Warehouse employee', quote: 'I do a lot of overtime and used to lose track. Shiftly shows my 1.5× hours separately, so I finally know my real pay.' },
        { name: 'Marta',  role: 'Restaurant manager',  quote: 'Logging a shift takes seconds and I can export the month when it’s time to settle up. Much simpler than my old spreadsheet.' },
        { name: 'Daniel', role: 'Shift supervisor',    quote: 'The overtime multiplier is honest and matches what I actually get paid. That alone made it worth switching.' },
        { name: 'Olena',  role: 'Early beta tester',   quote: 'It’s early, but it already nails the one thing I need — turning my hours into an exact number I can trust.' },
        { name: 'Tomasz', role: 'Delivery driver',     quote: 'I check my earnings for the week before payday and there are no surprises anymore.' },
      ],
    },
    footer: {
  ...
  ru: {
    ...
    stats: {
      kicker: 'В цифрах',
      title: 'Создано для сменных работников — честно с первого дня',
      items: [
        { label: 'Валют',             description: 'PLN, RUB, USD, EUR, GBP и другие — меняйте в любой момент' },
        { label: 'Ставки сверхуроч.', description: 'Множители 1.25×, 1.5× и 2× уже встроены' },
        { label: 'Цена',              description: 'Бесплатно в раннем доступе — без карты' },
        { label: 'На смену',          description: 'Среднее время, чтобы отметить смену' },
      ],
    },
    comparison: {
    ...
    modal: {
      title: 'Скоро',
      desc: 'Эта платформа пока в разработке. Оставьте email — и мы сообщим, когда она будет готова.',
      close: 'Закрыть',
    },
    testimonials: {
      badge: 'Ранний доступ',
      title: 'Что говорят первые тестировщики',
      sub: 'Shiftly в раннем доступе. Это честные отзывы сменных работников, которые пробуют его сейчас.',
      note: 'Ранний доступ · отзывы наших первых тестировщиков',
      items: [
        { name: 'Кацпер',  role: 'Работник склада',    quote: 'У меня много сверхурочных, и раньше я их терял. Shiftly показывает часы по 1.5× отдельно — теперь я знаю реальную оплату.' },
        { name: 'Марта',   role: 'Менеджер ресторана', quote: 'Отметить смену — пара секунд, а в конце месяца можно выгрузить отчёт. Намного проще старой таблицы.' },
        { name: 'Даниэль', role: 'Старший смены',       quote: 'Множитель сверхурочных честный и совпадает с тем, что мне реально платят. Уже ради этого стоило перейти.' },
        { name: 'Олена',   role: 'Бета-тестировщик',    quote: 'Пока рано, но главное приложение уже делает идеально — превращает часы в точную сумму, которой можно доверять.' },
        { name: 'Томаш',   role: 'Курьер',              quote: 'Проверяю заработок за неделю до зарплаты — и больше никаких сюрпризов.' },
      ],
    },
    footer: {
  ...
  pl: {
    ...
    stats: {
      kicker: 'W liczbach',
      title: 'Stworzone dla pracowników zmianowych — uczciwie od pierwszego dnia',
      items: [
        { label: 'Walut',            description: 'PLN, RUB, USD, EUR, GBP i więcej — zmień kiedy chcesz' },
        { label: 'Stawki nadgodzin', description: 'Mnożniki 1.25×, 1.5× i 2× wbudowane' },
        { label: 'Cena',             description: 'Za darmo we wczesnym dostępie — bez karty' },
        { label: 'Na zmianę',        description: 'Średni czas zapisania zmiany' },
      ],
    },
    comparison: {
    ...
    modal: {
      title: 'Wkrótce',
      desc: 'Ta platforma jest obecnie w budowie. Zostaw e-mail, a powiadomimy Cię, gdy będzie dostępna.',
      close: 'Zamknij',
    },
    testimonials: {
      badge: 'Wczesny dostęp',
      title: 'Co mówią pierwsi testerzy',
      sub: 'Shiftly jest we wczesnym dostępie. Oto szczere opinie pracowników zmianowych, którzy go teraz testują.',
      note: 'Wczesny dostęp · opinie naszych pierwszych testerów',
      items: [
        { name: 'Kacper', role: 'Pracownik magazynu',     quote: 'Mam dużo nadgodzin i często je gubiłem. Shiftly pokazuje godziny 1.5× osobno, więc w końcu znam realną wypłatę.' },
        { name: 'Marta',  role: 'Menedżerka restauracji',  quote: 'Zapis zmiany zajmuje sekundy, a na koniec miesiąca eksportuję raport. Dużo prościej niż mój stary arkusz.' },
        { name: 'Daniel', role: 'Kierownik zmiany',        quote: 'Mnożnik nadgodzin jest uczciwy i zgadza się z tym, co naprawdę dostaję. Już dla tego warto było się przesiąść.' },
        { name: 'Olena',  role: 'Tester wczesnego dostępu',quote: 'Jest wcześnie, ale robi idealnie to jedno, czego potrzebuję — zamienia godziny w dokładną kwotę, której ufam.' },
        { name: 'Tomasz', role: 'Kierowca dostaw',         quote: 'Sprawdzam zarobki na tydzień przed wypłatą i nie ma już żadnych niespodzianek.' },
      ],
    },
    footer: {
